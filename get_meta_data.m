function [ meta ] = get_meta_data( full_nii_path,full_dcm_path,pha_id)
...
disp(['Extracting scan meta-data for ' pha_id]);

%Get dMRI dcm
dcm = [fullfile(full_dcm_path,pha_id) '.dcm'];
json = [fullfile(full_nii_path,pha_id) '.json'];
